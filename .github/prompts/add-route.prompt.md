---
description: "Add a new Express API route with proper middleware, validation, and RBAC. Follows established patterns for authentication and error handling."
agent: "api"
...
5. Mount the route in `packages/api/src/index.ts` at the correct position in the middleware chain
